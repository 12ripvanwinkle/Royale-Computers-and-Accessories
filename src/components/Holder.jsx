...
// ── Icon accent bubble (used in the icon-grid card) ───────────────────────
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        {/* ══════════════════════════════════════════
            UNIQUE BENTO — 4-column base grid
            ┌─────────────────┬──────────┬──────────┐
            │                 │  Cloud   │  Mobile  │
            │   Tall anchor   ├──────────┴──────────┤
            │   (Security)    │    Payments wide    │
            ├────────┬────────┴──────────────────────┤  <- col-span changes
            │ Notif. │   Icon tech stack strip        │
            └────────┴────────────────────────────────┘

            In Tailwind 4-col terms:
            Row 1: [Security col-span-1 row-span-2*] [Cloud col-span-1] [Mobile col-span-2]
            Row 2: [Security continues...]           [Payments col-span-3]
            Row 3: [Notifications col-span-1]        [Tech stack col-span-3]

            *row-span via flex trick on mobile, md:grid-rows trick on desktop
            Simplified for Tailwind compatibility:
            Row 1: [Cloud col-span-2]          [Mobile col-span-2]
            Row 2: [Security col-span-1]        [Payments col-span-2]      [Notifications col-span-1]
            Row 3: [Tech stack strip col-span-4 / col-span-3 full]
        ══════════════════════════════════════════ */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">

          {/* ══ ROW 1: two equal halves ════════════════════════════════════ */}

          {/* ── Cloud Platform — col-span-2 ── */}
          <div
          ...
          {/* ── Secure Data — tall accent card (col-span-1) ── */}
          <div
          ...
          {/* ── Payment Gateways — wide (col-span-2) ── */}
          <div
            className="md:col-span-2 rounded-2xl p-5 md:p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
            style={cs("payments")}
            {...hp("payments")}
          ...
          {/* ── Notifications — narrow (col-span-1) ── */}
          <div
            className="md:col-span-1 rounded-2xl p-5 md:p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
            style={cs("notif")}
            {...hp("notif")}
          ...
          {/* ══ ROW 3: Full-width tech stack strip (col-span-4) ═══════════ */}
          <div
            className="md:col-span-4 rounded-2xl p-5 md:p-6 hover:-translate-y-0.5 transition-transform duration-300"
            style={glassStrong}
          >
            {/* Header row */}
