  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        {/* ══════════════════════════════════════════
            BENTO — 4-col base grid, fresh layout
            Row 1: [Education col-span-1] [Easy UI col-span-2]  [Scalable col-span-1]
            Row 2: [Testimonials col-span-2] [Support col-span-1] [Stats col-span-1]
            Row 3: [Full CTA strip col-span-4]
        ══════════════════════════════════════════ */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">

          {/* ══ ROW 1 ══════════════════════════════════════════════════════ */}

          {/* ── Education-focused — narrow accent card (col-span-1) ── */}
          <div
          ...
          {/* ── Easy-to-use UI — wide hero (col-span-2) ── */}
          <div
          ...
          {/* ── Scalable — narrow card (col-span-1) ── */}
          <div
            className="md:col-span-1 rounded-2xl p-5 md:p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
            style={cs("scale")}
            {...hp("scale")}
          ...
          {/* ── Support & Training — narrow (col-span-1) ── */}
          <div
            className="md:col-span-1 rounded-2xl p-5 md:p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
            style={cs("support")}
            {...hp("support")}
          ...
          {/* ── Numbers card — pure stat card (col-span-1) ── */}
          <div
          ...
          {/* ══ ROW 3: Full-width CTA strip (col-span-4) ══════════════════ */}
          <div
            className="md:col-span-4 rounded-2xl p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-5 hover:-translate-y-0.5 transition-transform duration-300"
            style={glassStrong}
          >
            {/* Left: promise list */}
