    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        {/* ══════════════════════════════════════════
            ...
            Row 1: [Student Mgmt col-span-2]  [Attendance col-span-1]
            Row 2: [Grade Mgmt col-span-1]    [Timetable col-span-2]
            Row 3: [Parent Portal col-span-1] [Fee Mgmt col-span-1] [Stats strip col-span-1]
        ══════════════════════════════════════════ */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">

          {/* ── CARD 1: Student Management — wide (col-span-2) ── */}
          <div
          ...
          {/* ── CARD 2: Attendance Tracking — narrow (col-span-1) ── */}
          <div
          ...
          {/* ── CARD 3: Grade Management — narrow (col-span-1) ── */}
          <div
            className="md:col-span-1 rounded-2xl p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
            style={cs("grades")}
            {...hp("grades")}
          >
            ...
            <h3 className="text-base font-semibold text-white mt-4 mb-2">
              Flexible Grading, Clear Insights
            </h3>
            <p className="text-sm leading-relaxed mb-4" style={{ color: "rgba(255,255,255,0.6)" }}>
          ...
          {/* ── CARD 4: Timetable Scheduling — wide (col-span-2) ── */}
          <div
            className="md:col-span-2 rounded-2xl p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
            style={cs("timetable")}
            {...hp("timetable")}
          ...
          {/* ── CARD 5: Parent Portal — narrow (col-span-1) ── */}
          <div
            className="md:col-span-1 rounded-2xl p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
            style={cs("parents")}
            {...hp("parents")}
          ...
          {/* ── CARD 6: Fee Management — narrow (col-span-1) ── */}
          <div
            className="md:col-span-1 rounded-2xl p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
            style={cs("fees")}
            {...hp("fees")}
          ...
          {/* ── CARD 7: Stats strip — full width (col-span-1 balances row 3) ── */}
          <div
            className="md:col-span-1 rounded-2xl p-6 flex flex-col justify-between hover:-translate-y-0.5 transition-transform duration-300"
            style={{ ...glassStrong }}
          >
            <p
              className="text-xs font-semibold tracking-widest uppercase mb-4"
