    ...
    <section className="mt-70">
        <div className="min-h-screen flex flex-col items-center justify-start pt-8 md:pt-16 px-4 md:px-6">
            ...
            <div className="text-center mb-6 md:mb-8">
                <TitleHeader title="CRM Software" className="" />
            ...
            <div className="text-center mt-20 max-w-3xl mx-auto px-4">
                <h2 className="text-4xl sm:text-5xl font-light text-white leading-tight mb-6">
                    Complete visibility for every relationship.

                </h2>
                <p className="text-base sm:text-lg font-light leading-relaxed"
                    style={{color: "rgba(255,255,255,0.62)"}}
                >
                    Our CRM solutions transform standard customer databases into high-performance growth ecosystems that deliver
                    up to 99.9% more engagement than traditional legacy systems. Using our centralized cloud-based platform, 
