...
import { techSolutionsItems, TechSolutionstestimonials } from "../../constants";
    ...
    <section id="TechSolutions" ref={sectionRef} className="mt-70">
      <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-20" id="testimonials">
            <Testimonials title="What Our Clients Say" subtitle="Real feedback from real people." testimonials={TechSolutionstestimonials} sectionId="reviews" />
        </div>
