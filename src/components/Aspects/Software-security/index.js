...
export const features = [
  ...
  },
  {
    ...
    highlights: ['AES-256 at rest', 'TLS 1.3 in transit', 'Encrypted backups', 'Key management options'],
  ...
  },
  {
    ...
    highlights: ['TOTP & SMS support', 'Enforced for all admins', 'SSO-compatible', 'Backup codes provided'],
