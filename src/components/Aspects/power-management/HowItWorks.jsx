...
import {Assessmentchecks, layers, Installtasks, steps} from './index'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs" style={{ color: '#a78bfa' }}>{done}/{Installtasks.length} done</span>
      </div>

      <div className="p-3 flex flex-col gap-1.5">
        {Installtasks.map((t, i) => (
          <div key={i} className="flex items-center gap-2.5 px-2 py-1.5 rounded-lg transition-all duration-300"
          ...
          {months.map((m,i) => (
            <div key={m} className="flex-1 flex flex-col items-center gap-1">
                <div className="w-full flex items-end gap-0.5" style={{height: 40}}>
                  ...
                  />
                  <div className="flex rounded-sm transition-all duration-500" 
