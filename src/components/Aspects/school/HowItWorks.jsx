    ...
    >
        <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {/* Step 1: Requirements - Wide Content Card*/}
                ...
                {/* Step 3: Data Import - Narrow Feature Card */}
                <div className="md:col-span-1 rounded-2xl p-5 md:p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
                    style={cs("s3")}
                    {...hp("s3")}
                >
                ...
                {/* Step 4: Staff Training - Narrow feature card */}
                <div className="md:col-span-1 rounded-2xl p-5 md:p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
                    style={cs("s4")}
                    {...hp("s4")}
                >
                ...
                {/* Step 6: Ongoing Support - Wide Content Card */}
                <div className="md:col-span-2 rounded-2xl p-5 md:p-6 flex flex-col hover:-translate-y-0.5 transition-transform duration-300"
                    style={cs("s6")}
                    {...hp("s6")}
                >
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                        ...
                        <button className="shrink-0 self-start sm:self-auto flex items-center gap-2 px-5 py-2 rounded-full text-xs font-semibold transition-all duration-200 hover:opacity-90 active:scale-95"
                            style={{
