                    ...
                    >  
                        ...
                        <div className="px-6 pt-6 pb-4"  
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">  
                                ...
                                <div key={s.label} className="rounded-lg px-3 py-2 text-center w-full"  
                                    style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.1)" }}>  
                                    <div className="text-sm font-bold text-white leading-tight wrap-break-word">{s.stat}</div>  
                                    <div className="text-xs mt-0.5 leading-snug" style={{ color: "rgba(255,255,255,0.45)" }}>{s.label}</div>  
                                </div>  
                                ))}  
                            </div>  
                        </div>
